...
export interface RepositoryContract {
	...
	getById: (UserId: number) => Promise<User | string | null>;
}

export interface ServiceContract {
	registration: (UserData: CreateUser) => Promise<CreateUser| string>;
	login: (UserData: LoginUser) => Promise<string>;
...
export interface ControllerContract {
	...
	getById: (
		req: Request<{ id: number }, User | string | null, object>,
		res: Response<User | string | null>,
	) => Promise<void>;
}
